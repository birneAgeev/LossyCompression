...
namespace WindowsFormsTemp.Compression.Jpeg
{
    public class JpegCoder : IJpegCoder
    {
        ...
        {
            var thinnerResult = Thinner.Instance.ThinOut(bitmap.ToYCrCbBitmap(), settings.ThinningMode);
        ...
        public IBitmap Decode(byte[] data)
        {
            ...
            var widthDivisor = Thinner.ModeToDividers[jpegData.Settings.ThinningMode].Item2;
            var heightDivisor = Thinner.ModeToDividers[jpegData.Settings.ThinningMode].Item1;

            var thinnerData = new ThinnerResult
            {
            ...
            return Thinner.Instance.Decompress(thinnerData);
        }
