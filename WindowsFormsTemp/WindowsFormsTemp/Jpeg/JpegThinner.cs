...
namespace WindowsFormsTemp.Jpeg
{
    public class JpegThinner
    {
        ...
        public JpegThinnerResult ThinOut(IBitmap bitmap, ThinningMode thinningMode)
        {
            var bmp = bitmap.ToYCrCbBitmap();
            return new JpegThinnerResult
            {
        ...
        public IBitmap Decompress(JpegThinnerResult compressedData)
        {
